...
/**
 * optional int32 peers = 1;
 * @return {number}
 */
proto.xudrpc.GetInfoResponse.prototype.getPeers = function() {
  return /** @type {number} */ (jspb.Message.getFieldProto3(this, 1, 0));
};


/** @param {number} value  */
proto.xudrpc.GetInfoResponse.prototype.setPeers = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional int32 pairs = 2;
 * @return {number}
 */
proto.xudrpc.GetInfoResponse.prototype.getPairs = function() {
  return /** @type {number} */ (jspb.Message.getFieldProto3(this, 2, 0));
};


/** @param {number} value  */
proto.xudrpc.GetInfoResponse.prototype.setPairs = function(value) {
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.xudrpc.OrdersCount.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getPeer();
  if (f !== 0) {
    writer.writeInt32(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.xudrpc.OrdersCount} The clone.
 */
proto.xudrpc.OrdersCount.prototype.cloneMessage = function() {
  return /** @type {!proto.xudrpc.OrdersCount} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @const
 */
proto.xudrpc.LndInfo.repeatedFields_ = [4];
...
proto.xudrpc.LndInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    urisList: jspb.Message.getField(msg, 4),
    version: msg.getVersion()
  };
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.xudrpc.LndInfo.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getError();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.xudrpc.LndInfo} The clone.
 */
proto.xudrpc.LndInfo.prototype.cloneMessage = function() {
  return /** @type {!proto.xudrpc.LndInfo} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.xudrpc.LndChannels.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getActive();
  if (f !== 0) {
    writer.writeInt32(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.xudrpc.LndChannels} The clone.
 */
proto.xudrpc.LndChannels.prototype.cloneMessage = function() {
  return /** @type {!proto.xudrpc.LndChannels} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.xudrpc.RaidenInfo.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getError();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.xudrpc.RaidenInfo} The clone.
 */
proto.xudrpc.RaidenInfo.prototype.cloneMessage = function() {
  return /** @type {!proto.xudrpc.RaidenInfo} */ (jspb.Message.cloneMessage(this));
};
